 ...
 */
////是否登录（BOOL）
#define IsLogin  [CommenIdea isLogin]
//登录导航控制器
#define LoginNavi [CommenIdea loginNavi]
//拼接完整服务器路径图片
#define LOGOURL(url)  [CommenIdea imgUrl:(url)]
//拼接服务器返回路径的全路径
#define UserID [UserDefault objectForKey:@"userId"]
/**
 颜色
 */
...
#define BACKColor RGBColor(236, 241, 243)
#define IndicatorColor RGBColor(227, 230, 234)
#define APPColor RGBColor(97, 189, 252) //APP主题色
